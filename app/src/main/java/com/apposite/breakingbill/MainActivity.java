...
//
//        TextView tvMemberName = new TextView(MainActivity.this);
//        tvMemberName.setLayoutParams(new LinearLayout.LayoutParams(
//                LinearLayout.LayoutParams.WRAP_CONTENT,LinearLayout.LayoutParams.WRAP_CONTENT));
//        tvMemberName.setText("Sample Footer");
//        tvMemberName.setPadding(10,10,10,10);
//        llList.addView(tvMemberName);
//
//        listViewMain.addFooterView(llList);
...
//        for (UserInfo profile : mOwner.getProviderData()) {
...
//            OWNER_EMAIL = mOwner.getEmail();
//            //OWNER_PHOTO_URL = profile.getPhotoUrl();
//        }

        //Query mQuery = mUsers.orderByKey().equalTo(mOwner.getEmail());
